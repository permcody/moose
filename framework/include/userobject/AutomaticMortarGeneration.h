...
public:
  ...
  /**
   * This function adds lower-dimensional elements to the mesh corresponding
   * to the slave (and later possibly master) boundaries.
   * \returns the size of the largest lower-dimensional element added.
   */
  void add_lower_dimensional_elements();
