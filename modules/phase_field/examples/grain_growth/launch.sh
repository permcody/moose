...
do
  ...
  do
      ...
      echo_exec mpiexec -n $procs ../../phase_field-oprof -i 2D_timing.i GlobalParams/op_num=$grains ICs/PolycrystalICs/PolycrystalVoronoiIC/grain_num=$grains Postprocessors/grain_tracker/type=FauxGrainTracker Postprocessors/time_gt_execute/category=FauxGrainTracker Postprocessors/time_gt_finalize/category=FauxGrainTracker
